...
export const CHARACTER_SVG: Record<string, string> = {
  ...
  engineer: C([
    // Jumpsuit body
    p('M22 26 L18 34 L16 54 L28 60 L36 60 L48 54 L46 34 L42 26Z', '#c09030'),
    // Jumpsuit front zip
    p('M30 26 L34 26 L34 58 L30 58Z', '#d0a040'),
    // Belt
    p('M18 40 L46 40 L46 43 L18 43Z', '#5a4020'),
    rc(30, 40, 4, 3, '#888'),
    // Shoulder pads
    p('M20 24 L26 22 L26 28 L18 30Z', '#a08028'),
    p('M44 24 L38 22 L38 28 L46 30Z', '#a08028'),
    // Head
    ci(32, 16, 8, '#f0c8a0'),
    // Goggles
    p('M24 13 L40 13 L40 19 L24 19Z', '#40404080'),
    ci(28, 16, 3, '#80c0ff60'),
    ci(36, 16, 3, '#80c0ff60'),
    p('M24 14 L40 14 L40 15 L24 15Z', '#606060'),
    // Short hair
    p('M24 8 L28 5 L36 5 L40 8 L40 14 L24 14Z', '#4a3520'),
    // Eyes behind goggles
    ci(28, 16, 1, '#1a1a2e'),
    ci(36, 16, 1, '#1a1a2e'),
    // Wrench tool
    rc(48, 18, 2, 40, '#707070'),
    p('M46 16 L50 14 L52 16 L52 22 L46 22Z', '#888'),
    p('M46 54 L50 52 L52 54 L52 58 L46 58Z', '#888'),
    // Hovering drone
    ci(10, 12, 4, '#60606080'),
    p('M6 10 L14 10 L14 14 L6 14Z', '#808080'),
    p('M4 11 L6 10 L6 14 L4 13Z', '#a0a0a0'),
    p('M14 11 L16 10 L16 14 L14 13Z', '#a0a0a0'),
    ci(10, 12, 1.5, '#ff6030'),
    // Boots
    p('M24 58 L22 63 L30 63 L28 58Z', '#5a4020'),
    p('M36 58 L34 63 L42 63 L40 58Z', '#5a4020'),
  ].join('')),

  gambler: C([
    // Suit jacket
    p('M20 26 L16 34 L14 56 L28 60 L36 60 L50 56 L48 34 L44 26Z', '#2a1a30'),
    // Lapels
    p('M28 26 L24 34 L28 42 L32 26Z', '#3a2a40'),
    p('M36 26 L40 34 L36 42 L32 26Z', '#3a2a40'),
    // Shirt
    p('M28 26 L32 26 L36 26 L36 56 L28 56Z', '#e8e0d0'),
    // Tie
    p('M30 26 L32 24 L34 26 L33 42 L32 44 L31 42Z', '#c03030'),
    // Vest
    p('M28 34 L24 34 L22 56 L28 58Z', '#4a2050'),
    p('M36 34 L40 34 L42 56 L36 58Z', '#4a2050'),
    // Head
    ci(32, 16, 8, '#f0c8a0'),
    // Hat
    p('M20 14 L44 14 L44 16 L20 16Z', '#1a0a20'),
    p('M24 6 L40 6 L42 14 L22 14Z', '#2a1a30'),
    p('M26 6 L38 6 L38 8 L26 8Z', '#c03030'),
    // Eyes
    ci(28, 16, 1.5, '#1a1a2e'),
    ci(36, 16, 1.5, '#1a1a2e'),
    // Smirk
    p('M29 20 L35 20 L34 21 L30 21Z', '#c08080'),
    // Dice in hand
    rc(46, 28, 8, 8, '#f0f0f0'),
    ci(48, 30, 0.8, '#222'),
    ci(52, 30, 0.8, '#222'),
...
export const ENEMY_SVG: Record<string, string> = {
  ...
  entropy_wraith: C([
    p('M28 10 L22 20 L18 44 L24 58 L40 58 L46 44 L42 20 L36 10Z', '#281830'),
    p('M30 14 L26 22 L22 42 L28 54 L36 54 L42 42 L38 22 L34 14Z', '#351e3c'),
    ci(29, 22, 2.5, '#ff4060'),
    ci(35, 22, 2.5, '#ff4060'),
    ci(29, 22, 1, '#ff8090'),
    ci(35, 22, 1, '#ff8090'),
    p('M18 44 L10 40 L8 50 L16 52Z', '#281830'),
    p('M46 44 L54 40 L56 50 L48 52Z', '#281830'),
    ci(32, 36, 8, '#ff406020'),
    ci(32, 36, 4, '#ff406020'),
    p('M24 56 L22 64 L30 64 L28 56Z', '#201028'),
    p('M36 56 L34 64 L42 64 L40 56Z', '#201028'),
  ].join('')),

  null_sentinel: C([
    p('M20 8 L14 20 L12 46 L22 58 L42 58 L52 46 L50 20 L44 8Z', '#2a3040'),
    p('M24 12 L18 22 L16 44 L24 54 L40 54 L48 44 L46 22 L40 12Z', '#364050'),
    rc(26, 20, 12, 8, '#506070'),
    ci(30, 24, 2, '#60e0ff'),
    ci(38, 24, 2, '#60e0ff'),
    ci(30, 24, 1, '#a0f0ff'),
    ci(38, 24, 1, '#a0f0ff'),
    p('M12 20 L4 18 L2 34 L10 36Z', '#2a3040'),
    p('M52 20 L60 18 L62 34 L54 36Z', '#2a3040'),
    p('M2 34 L0 40 L8 42 L10 36Z', '#364050'),
    p('M62 34 L64 40 L56 42 L54 36Z', '#364050'),
    p('M22 56 L20 64 L32 64 L30 56Z', '#222830'),
    p('M34 56 L32 64 L44 64 L42 56Z', '#222830'),
    ci(34, 40, 5, '#60e0ff18'),
  ].join('')),

  paradox_shade: C([
    p('M30 8 L22 16 L20 44 L28 56 L36 56 L44 44 L42 16 L34 8Z', '#1a1028'),
    p('M32 12 L26 18 L24 42 L30 52 L34 52 L40 42 L38 18 L32 12Z', '#24163a'),
    ci(29, 24, 2, '#c060ff'),
    ci(35, 24, 2, '#c060ff'),
    ci(29, 24, 1, '#e0a0ff'),
    ci(35, 24, 1, '#e0a0ff'),
    p('M20 30 L12 28 L10 38 L18 40Z', '#1a102840'),
    p('M44 30 L52 28 L54 38 L46 40Z', '#1a102840'),
    ci(32, 36, 6, '#c060ff15'),
    ci(32, 36, 3, '#c060ff15'),
    p('M28 54 L26 62 L34 62 L32 54Z', '#12081c'),
    p('M34 54 L32 62 L40 62 L38 54Z', '#12081c'),
  ].join('')),
...
export const RELIC_SVG: Record<string, string> = {
  ...
  drone_core: C(
    ci(32, 32, 20, '#3a3a3a') +
    ci(32, 32, 16, '#505050') +
    rc(24, 24, 16, 16, '#707070') +
    ci(32, 32, 8, '#ff8030') +
    ci(32, 32, 4, '#ffc060') +
    ci(32, 30, 2, '#ffffff') +
    p('M20 18 L26 14 L26 20 L20 22Z', '#808080') +
    p('M44 18 L38 14 L38 20 L44 22Z', '#808080') +
    p('M20 46 L26 50 L26 44 L20 42Z', '#808080') +
    p('M44 46 L38 50 L38 44 L44 42Z', '#808080')
  ),

  energy_battery: C(
    rc(18, 12, 28, 44, '#404040') +
    rc(20, 14, 24, 40, '#606060') +
    rc(26, 8, 12, 6, '#808080') +
    p('M22 20 L42 20 L42 28 L22 28Z', '#40c040') +
    p('M22 32 L42 32 L42 40 L22 40Z', '#30a030') +
    p('M22 44 L42 44 L42 50 L22 50Z', '#208020') +
    ci(32, 24, 2, '#80ff80') +
    p('M30 16 L34 16 L34 18 L30 18Z', '#ffcc00')
  ),

  prototype_chip: C(
    rc(14, 14, 36, 36, '#2a5030') +
    rc(16, 16, 32, 32, '#306038') +
    ci(32, 32, 10, '#404040') +
    ci(32, 32, 6, '#606060') +
    ci(32, 32, 3, '#ff6030') +
    p('M10 22 L14 22 L14 26 L10 26Z', '#808080') +
    p('M10 38 L14 38 L14 42 L10 42Z', '#808080') +
    p('M50 22 L54 22 L54 26 L50 26Z', '#808080') +
    p('M50 38 L54 38 L54 42 L50 42Z', '#808080') +
    p('M22 10 L26 10 L26 14 L22 14Z', '#808080') +
    p('M38 10 L42 10 L42 14 L38 14Z', '#808080') +
    p('M22 50 L26 50 L26 54 L22 54Z', '#808080') +
    p('M38 50 L42 50 L42 54 L38 54Z', '#808080')
  ),
  ...
  lucky_coin: C(
    ...
    ci(32, 32, 12, '#f0d860') +
    ci(32, 32, 3, '#c8a020') +
    p('M30 26 L34 26 L34 38 L30 38Z', '#c8a020') +
    p('M26 30 L38 30 L38 34 L26 34Z', '#c8a020')
  ),

  gamblers_instinct: C(
    rc(16, 16, 32, 32, '#2a1a30') +
    rc(18, 18, 28, 28, '#3a2a40') +
    ci(32, 28, 6, '#f0f0f0') +
    ci(29, 26, 1, '#222') +
    ci(35, 26, 1, '#222') +
    ci(32, 30, 1, '#222') +
    ci(32, 38, 4, '#c03030') +
    p('M28 42 L36 42 L34 48 L30 48Z', '#c03030')
  ),

  loaded_die: C(
    rc(14, 14, 36, 36, '#f0f0f0') +
    rc(16, 16, 32, 32, '#e8e0d0') +
    ci(24, 24, 2, '#c03030') +
    ci(40, 24, 2, '#c03030') +
    ci(24, 40, 2, '#c03030') +
    ci(40, 40, 2, '#c03030') +
...
export const EVENT_SVG: Record<string, string> = {
  ...
  // 🗝️ 도적 암시장 — thief's hidden fence
  thief_fence: C(
    rc(4, 4, 56, 56, '#12101A') +
    rc(8, 22, 48, 32, '#1A1428') +
    p('M8 22 L32 10 L56 22', '#2A1A3A') +
    rc(22, 30, 20, 24, '#0E0A18') +
    rc(14, 36, 8, 6, '#3A2A4A') +
    rc(42, 36, 8, 6, '#3A2A4A') +
    ci(18, 39, 1.5, '#FF6644') +
    ci(46, 39, 1.5, '#44FF88') +
    p('M26 30 L32 24 L38 30', '#8A6ACA') +
    ci(32, 26, 2, '#FFD700') +
    p('M16 48 L20 44 L22 48', '#666') +
    p('M40 48 L44 44 L46 48', '#666')
  ),
...
export const ACHIEVEMENT_SVG: Record<string, string> = {
  ...
  engineer_clear: C(
    ...
    ci(32, 32, 8, '#808080') +
    ci(32, 32, 4, '#404040') +
    p('M28 4 L36 4 L36 12 L28 12Z', '#808080') +
    p('M28 52 L36 52 L36 60 L28 60Z', '#808080') +
    p('M4 28 L12 28 L12 36 L4 36Z', '#808080') +
    p('M52 28 L60 28 L60 36 L52 36Z', '#808080') +
    ci(32, 32, 2, '#ff8030')
  ),
