...
export const THIEF_CARD_DEFS: Record<string, CardDef> = {
  ...
  t_molting: {
    ...
    effects: [{ kind: 'block', amount: 8 }, { kind: 'draw', amount: 1 }],
  },
  t_shadow_cut: {
    id: 't_shadow_cut',
    name: '그림자 베기',
  ...
  t_combo_strike: {
    ...
    name: '연계 베기',
    type: 'attack', rarity: 'uncommon', cost: 1, target: 'enemy',
    description: '7 데미지. 이번 턴 2번째 이후 카드면 +7 데미지.',
    effects: [
...
export const THIEF_UPGRADE_MAP: Record<string, Partial<CardDef>> = {
  ...
  t_shining_cut:     { name: '섬광 베기+',       description: '7 데미지 2회.',                          effects: [{ kind: 'damage', amount: 7, times: 2 }] },
  ...
  t_molting:         { name: '은신: 허물벗기+',   description: '방어도 +11. 1장 드로우.',                effects: [{ kind: 'block', amount: 11 }, { kind: 'draw', amount: 1 }] },
  ...
  t_combo_strike:    { name: '연계 베기+',       description: '10 데미지. 이번 턴 2번째 이후 카드면 +8 데미지.',
                       effects: [{ kind: 'damage', amount: 10 }, { kind: 'conditional', condition: { kind: 'nth_or_more', n: 2 }, then: [{ kind: 'damage', amount: 8 }] }] },
