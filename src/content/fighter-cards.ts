...
const FIGHTER_UPGRADE_MAP: Record<string, Partial<CardDef>> = {
  f_quick_kick:    { name: '질풍 발차기+',                   description: '9 데미지.',                              effects: [{ kind: 'damage', amount: 9 }] },
  ...
  f_focus:         { name: '번개 던지기+',                     description: '방어도 +9. 무작위 카드 1장 소멸.',      effects: [{ kind: 'block', amount: 9 }, { kind: 'exhaust_random_hand' }] },
  ...
  f_red_dragon:    { name: '용의 분노+',                  description: '카드 소멸 시 방어도 +5.',                effects: [{ kind: 'apply_self', status: 'on_exhaust_block', amount: 5 }] },
