...
const GAMBLER_UPGRADE_MAP: Record<string, Partial<CardDef>> = {
  ...
  b_loaded_dice:  { name: '세공 주사위+',     description: '턴 시작 시 힘 +2.',                                         effects: [{ kind: 'apply_self', status: 'ritual', amount: 2 }] },
  ...
  b_poison_bet:   { name: '독배 내기+',       description: '3 × 🎲 데미지. 3 × 🎲 중독.',                              effects: [{ kind: 'damage_dice', base: 3 }, { kind: 'apply_enemy_dice', status: 'poison', base: 3 }] },
