...
Object.assign(CARD_DEFS, GUNNER_CARD_DEFS, FIGHTER_CARD_DEFS, MAGICIAN_CARD_DEFS, PRIEST_CARD_DEFS);

export const CARD_LIST = Object.values(CARD_DEFS).filter(
  (c) => !c.id.startsWith('g_') && !c.id.startsWith('f_') && !c.id.startsWith('m_') && !c.id.startsWith('p_'),
);
